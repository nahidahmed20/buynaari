...
const { categories, subCategories } = defineProps({
    categories: Array,
    subCategories: Array
})
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row g-3 mb-4">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-control d-flex flex-wrap gap-2">
                                                ...
                                                <input type="text" v-model="inputValues.sizes" class="border-0 flex-grow-1" style="outline: none;"
                                                    placeholder="Add size" @keydown="handleKeydown('sizes', $event)" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-control d-flex flex-wrap gap-2">
                                                ...
                                                <input type="text" v-model="inputValues.colors" class="border-0 flex-grow-1" style="outline: none;"
                                                    placeholder="Add color" @keydown="handleKeydown('colors', $event)" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-control d-flex flex-wrap gap-2">
                                                ...
                                                <input type="text" v-model="inputValues.tags" class="border-0 flex-grow-1" style="outline: none;"
                                                    placeholder="Add tag" @keydown="handleKeydown('tags', $event)" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-3 mb-4">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-control d-flex flex-wrap gap-2">
                                                ...
                                                <input type="text" v-model="inputValues.meta_keywords" class="border-0 flex-grow-1" style="outline: none;"
                                                    placeholder="Add keyword" @keydown="handleKeydown('meta_keywords', $event)" />
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <Link :href="route('products.index')" class="btn btn-danger rounded-pill px-4 me-2 shadow-sm">
                                            Cancel
                                        </Link>
