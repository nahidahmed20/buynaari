    ...
    <div class="main-nav">
               ...
               <div class="scrollbar" data-simplebar>
                    <ul class="navbar-nav" id="navbar-nav">
                         ...
                         <li class="nav-item">
                         <Link class="nav-link" :href="route('dashboard')" @click.prevent="window.location.href = route('dashboard')">
                              <span class="nav-icon">
                         ...
                         <div class="collapse" id="sidebarUsers">
                              <ul class="nav sub-navbar-nav">
                                   <li class="sub-nav-item">
                                        <Link class="sub-nav-link" :href="route('users.index')" @click.prevent="window.location.href = route('users.index')">List</Link>
                                   </li>
                                   <li class="sub-nav-item">
                                        <Link class="sub-nav-link" :href="route('users.create')" @click.prevent="window.location.href = route('users.create')">Create</Link>
                                   </li>
                              </ul>
                         </div>
                         </li>
                         ...
                         <li class="nav-item">
                         <a class="nav-link menu-arrow" href="#sidebarPermission" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarPermission">
                              <span class="nav-icon">
                         ...
                         <div class="collapse" id="sidebarPermission">
                              <ul class="nav sub-navbar-nav">
                                   <li class="sub-nav-item">
                                        <Link class="sub-nav-link" :href="route('permissions.index')" @click.prevent="window.location.href = route('permissions.index')">List</Link>
                                   </li>
                                   <li class="sub-nav-item">
                                        <Link class="sub-nav-link" :href="route('permissions.create')" @click.prevent="window.location.href = route('permissions.create')">Create</Link>
                                   </li>
                              </ul>
                         </div>
                         </li>
                         ...
                         <div class="collapse" id="sidebarRoles">
                              <ul class="nav sub-navbar-nav">
                                   <li class="sub-nav-item">
                                        <Link class="sub-nav-link" :href="route('roles.index')" @click.prevent="window.location.href = route('roles.index')">List</Link>
                                   </li>
                                   <li class="sub-nav-item">
                                        <Link class="sub-nav-link" :href="route('roles.create')" @click.prevent="window.location.href = route('roles.create')">Create</Link>
                                   </li>
                              </ul>
                         </div>
                         </li>
